...
from globals import noise, noise_str, phony_curl, phony_curl_str, z0

#### field map locations
# test / validation points (only one map)
mapfile_test = mu2e_ext_path+f'Bmaps/PINN_paper/Mu2e_V13_DSCartVal_Helicalc_All_Coils_All_Busbars_Rebar.Mu2E.p'
# fitting points
mapfile_125 = mu2e_ext_path+f'Bmaps/PINN_paper/Mu2e_V13_DSCylFMSAll_Helicalc_All_Coils_All_Busbars_Rebar{noise_str}.Mu2E.p'
mapfile_3 = mu2e_ext_path+f'Bmaps/PINN_paper/Mu2e_V13_DSCylFMSAll_Helicalc_All_Coils_All_Busbars_Rebar{noise_str}_external_fit.Mu2E.p'
mapfile_4 = mu2e_ext_path+f'Bmaps/PINN_paper/Mu2e_V13_DSCylFMSAll_Helicalc_All_Coils_All_Busbars_Rebar{noise_str}{phony_curl_str}.Mu2E.p'
...
cfg_geom_cart = cfg_geom('cart', z_steps=None, r_steps=None, phi_steps=None,
                        ...
                        interpolate=False, do2pi=False, do_selection=False)
# plot
cfg_plot_mpl = cfg_plot('mpl_nonuni', zlims=[-2, 2], save_loc='LSQ_fit', sub_dir=None, df_fine=None)
...
cfg_params_test = cfg_params(pitch1=0, ms_h1=0, ns_h1=0, pitch2=0, ms_h2=0, ns_h2=0,
                         ...
                         ks_dict={'k1': [mean_fields_dict['nominal']['Bx'], True],
                                  ...
                                  'k3': [mean_fields_dict['nominal']['Bx'], True],
                                  'k4': [0., True], 'k5': [0., True],
                                  'k6': [0., True], 'k7': [0., True],},
...
cfg_params1 = cfg_params(pitch1=0, ms_h1=0, ns_h1=0, pitch2=0, ms_h2=0, ns_h2=0,
                         ...
                         ks_dict={'k1': [mean_fields_dict['nominal']['Bx'], False],
                                  ...
                                  'k3': [mean_fields_dict['nominal']['Bx'], False],
...
cfg_pickle1 = cfg_pickle(use_pickle=False, save_pickle=True,
                         load_name=f'helicalc_Rebar{noise_str}',
                         save_name=f'helicalc_Rebar{noise_str}', recreate=False)
# test
cfg_pickle_test1 = cfg_pickle(use_pickle=True, save_pickle=False,
                              load_name=f'helicalc_Rebar{noise_str}',
                              save_name=f'helicalc_Rebar{noise_str}', recreate=True)
# PINN subracted fit
cfg_pickle_ps1 = cfg_pickle(use_pickle=True, save_pickle=True,
                         load_name=f'helicalc_Rebar{noise_str}',
                         save_name=f'helicalc_Rebar{noise_str}_PINN_subtracted', recreate=False)
# test, PINN subtracted
cfg_pickle_ps_test1 = cfg_pickle(use_pickle=True, save_pickle=False,
                                 load_name=f'helicalc_Rebar{noise_str}_PINN_subtracted',
                                 save_name=f'helicalc_Rebar{noise_str}_PINN_subtracted', recreate=True)
...
cfg_pickle2 = cfg_pickle(use_pickle=False, save_pickle=True,
                         load_name=f'helicalc_standard_PINN_Rebar{noise_str}',
                         save_name=f'helicalc_standard_PINN_Rebar{noise_str}', recreate=False)
# test
cfg_pickle_test2 = cfg_pickle(use_pickle=True, save_pickle=False,
                              load_name=f'helicalc_standard_PINN_Rebar{noise_str}',
                              save_name=f'helicalc_standard_PINN_Rebar{noise_str}', recreate=True)
# PINN subracted fit
cfg_pickle_ps2 = cfg_pickle(use_pickle=True, save_pickle=True,
                         load_name=f'helicalc_standard_PINN_Rebar{noise_str}',
                         save_name=f'helicalc_standard_PINN_Rebar{noise_str}_PINN_subtracted', recreate=False)
# test, PINN subtracted
cfg_pickle_ps_test2 = cfg_pickle(use_pickle=True, save_pickle=False,
                                 load_name=f'helicalc_standard_PINN_Rebar{noise_str}_PINN_subtracted',
                                 save_name=f'helicalc_standard_PINN_Rebar{noise_str}_PINN_subtracted', recreate=True)
...
cfg_pickle3 = cfg_pickle(use_pickle=False, save_pickle=True,
                         load_name=f'helicalc_Rebar{noise_str}_external_fit',
                         save_name=f'helicalc_Rebar{noise_str}_external_fit', recreate=False)
# test
cfg_pickle_test3 = cfg_pickle(use_pickle=True, save_pickle=False,
                              load_name=f'helicalc_Rebar{noise_str}_external_fit',
                              save_name=f'helicalc_Rebar{noise_str}_external_fit', recreate=True)
# PINN subracted fit
cfg_pickle_ps3 = cfg_pickle(use_pickle=True, save_pickle=True,
                         load_name=f'helicalc_Rebar{noise_str}_external_fit',
                         save_name=f'helicalc_Rebar{noise_str}_external_fit_PINN_subtracted', recreate=False)
# test, PINN subtracted
cfg_pickle_ps_test3 = cfg_pickle(use_pickle=True, save_pickle=False,
                                 load_name=f'helicalc_Rebar{noise_str}_external_fit_PINN_subtracted',
                                 save_name=f'helicalc_Rebar{noise_str}_external_fit_PINN_subtracted', recreate=True)
...
cfg_params4 = cfg_params(pitch1=0, ms_h1=0, ns_h1=0, pitch2=0, ms_h2=0, ns_h2=0,
                         ...
                         ks_dict={'k1': [mean_fields_dict['phony_curl']['Bx'], False],
                                  ...
                                  'k3': [mean_fields_dict['phony_curl']['Bx'], False],
                                  'k4': [0., True], 'k5': [0., False],
                                  'k6': [0., False], 'k7': [0., True],},
                         bs_tuples=None, bs_bounds=None,
                         loss='linear', method='leastsq',
...
cfg_pickle4 = cfg_pickle(use_pickle=False, save_pickle=True,
                         load_name=f'helicalc_Rebar{noise_str}{phony_curl_str}',
                         save_name=f'helicalc_Rebar{noise_str}{phony_curl_str}', recreate=False)
# test
cfg_pickle_test4 = cfg_pickle(use_pickle=True, save_pickle=False,
                              load_name=f'helicalc_Rebar{noise_str}{phony_curl_str}',
                              save_name=f'helicalc_Rebar{noise_str}{phony_curl_str}', recreate=True)
# PINN subracted fit
cfg_pickle_ps4 = cfg_pickle(use_pickle=True, save_pickle=True,
                         load_name=f'helicalc_Rebar{noise_str}{phony_curl_str}',
                         save_name=f'helicalc_Rebar{noise_str}{phony_curl_str}_PINN_subtracted', recreate=False)
# test, PINN subtracted
cfg_pickle_ps_test4 = cfg_pickle(use_pickle=True, save_pickle=False,
                                 load_name=f'helicalc_Rebar{noise_str}{phony_curl_str}_PINN_subtracted',
                                 save_name=f'helicalc_Rebar{noise_str}{phony_curl_str}_PINN_subtracted', recreate=True)
...
cfg_pickle5 = cfg_pickle(use_pickle=False, save_pickle=True,
                         load_name=f'helicalc_Rebar{noise_str}_cyl_sym_fit',
                         save_name=f'helicalc_Rebar{noise_str}_cyl_sym_fit', recreate=False)
# test
cfg_pickle_test5 = cfg_pickle(use_pickle=True, save_pickle=False,
                              load_name=f'helicalc_Rebar{noise_str}_cyl_sym_fit',
                              save_name=f'helicalc_Rebar{noise_str}_cyl_sym_fit', recreate=True)
# PINN subracted fit
cfg_pickle_ps5 = cfg_pickle(use_pickle=True, save_pickle=True,
                         load_name=f'helicalc_Rebar{noise_str}_cyl_sym_fit',
                         save_name=f'helicalc_Rebar{noise_str}_cyl_sym_fit_PINN_subtracted', recreate=False)
# test, PINN subtracted
cfg_pickle_ps_test5 = cfg_pickle(use_pickle=True, save_pickle=False,
                                 load_name=f'helicalc_Rebar{noise_str}_cyl_sym_fit_PINN_subtracted',
                                 save_name=f'helicalc_Rebar{noise_str}_cyl_sym_fit_PINN_subtracted', recreate=True)

#### Collect them all into a dictionary
LSQ_config_dict = {
    '1': {'cfg_data': cfg_data1, 'cfg_data_test': cfg_data_test,
